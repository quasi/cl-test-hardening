...
```json-schema
{
  ...
  "properties": {
    "name": {"type": "string"},
    "pattern": {"type": "string", "description": "S-expression pattern to match"},
    "replacement": {"type": "string", "description": "Replacement pattern"},
    "category": {"type": "string", "enum": ["arithmetic", "boolean", "conditional", "boundary", "literal"]},
    "description": {"type": "string"}
  },
  "required": ["name", "pattern", "replacement", "category"]
}
```
